...
@#$#@#$#@
<experiments>
  <experiment name="Size 1" repetitions="50" runMetricsEveryStep="false">
    <setup>SETUP</setup>
    <go>START</go>
  ...
  <experiment name="Size 2" repetitions="50" runMetricsEveryStep="false">
    <setup>SETUP</setup>
    <go>START</go>
    <timeLimit steps="1000"/>
    <metric>turtles_unattached</metric>
  ...
  <experiment name="Size 3" repetitions="50" runMetricsEveryStep="false">
    <setup>SETUP</setup>
    <go>START</go>
    <timeLimit steps="1000"/>
    <metric>turtles_unattached</metric>
  ...
  <experiment name="Size 4" repetitions="50" runMetricsEveryStep="false">
    <setup>SETUP</setup>
    <go>START</go>
    <timeLimit steps="1000"/>
    <metric>turtles_unattached</metric>
  ...
  <experiment name="Size 5" repetitions="50" runMetricsEveryStep="false">
    <setup>SETUP</setup>
    <go>START</go>
    <timeLimit steps="1000"/>
    <metric>turtles_unattached</metric>
  ...
  <experiment name="Size 6" repetitions="50" runMetricsEveryStep="false">
    <setup>SETUP</setup>
    <go>START</go>
    <timeLimit steps="1000"/>
    <metric>turtles_unattached</metric>
